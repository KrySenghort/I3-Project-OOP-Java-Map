...
public class Dijkstra {
  ...
  public void doDijkstra(String s) {
    ...
    /// method to find the closest vertex in the adjacency list of the discovered
    /// vertex
  ...
  public static void main(String[] argv) throws IOException {
    ...
    // Compute distances.
    // This is what happens when you click on the "Compute All Euclidean Distances"
    // button.
